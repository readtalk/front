...
import { Moon, Sun, Plus, Lock, SignOut, Chats, List, X } from "@phosphor-icons/react";
    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="flex flex-1 overflow-hidden">
                {/* Desktop Sidebar */}
                <div className="hidden md:block w-56 px-3 pt-6 border-r border-neutral-200 transition-colors dark:border-neutral-800 overflow-y-auto flex-shrink-0">
                    <SidebarContent />
                </div>
